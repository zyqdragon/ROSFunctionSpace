...
main (int argc, char **argv)
{
  ...
  pcl::io::loadPCDFile ("/home/zj/Desktop/basic_test/pcd_display_in_rviz/src/test.pcd", cloud);//更换为自己的pcd文件路径
...
//https://blog.csdn.net/rabbit_flowers/article/details/115339767
